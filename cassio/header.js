$(document).ready(function () {
    $('title').append(' | TL&#59;DRecipes');
    $('head').append('<!-- Font loading -->');
    $('head').append('<link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600" rel="stylesheet" type="text/css">');
